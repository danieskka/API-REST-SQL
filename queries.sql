...
UPDATE public.entries
	SET title='El inter gana la champions', content='Después de un partido único, se llevaron el gatito al agua', date=NOW(), id_author=(SELECT id_author FROM authors WHERE email='Javy@thebridgeschool.es'), category='Deportes'
